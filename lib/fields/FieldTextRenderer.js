...
var FieldTextRenderer = (function (_super) {
    ...
    FieldTextRenderer.prototype.onChange = function (evt) {
    ...
    FieldTextRenderer.prototype.renderNewOrEditForm = function () {
        return (React.createElement(TextField, { onChange: this.onChange.bind(this), value: this.state.currentValue == null ? '' : this.state.currentValue }));
    };
