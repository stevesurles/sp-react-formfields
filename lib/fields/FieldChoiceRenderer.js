    ...
    FieldChoiceRenderer.prototype.renderNewOrEditForm = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: mainStyle },
                React.createElement(Dropdown, { key: "dropdown_" + this.props.InternalName, multiSelect: this.props.IsMulti, onChange: function (evt, newValue) {
                        _this.setState({ ownOption: newValue }, function () {
            ...
            React.createElement("div", { style: auxStyle },
                React.createElement(TextField, { placeholder: 'Enter own option', value: this.state.ownOption == null ? '' : this.state.ownOption, onChange: function (evt, newValue) {
