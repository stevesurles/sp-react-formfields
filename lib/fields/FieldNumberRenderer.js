    ...
    FieldNumberRenderer.prototype.renderNewOrEditForm = function () {
        if (this.props.NumberIsPercent) {
            return (React.createElement(React.Fragment, null,
                React.createElement(TextField, { onChange: this.onChange, onKeyPress: this.onKeypress, value: this.state.currentValue == null ? '' : this.state.currentValue, prefix: '%' })));
        }
        else {
            return (React.createElement(React.Fragment, null,
                React.createElement(TextField, { onChange: this.onChange, onKeyPress: this.onKeypress, value: this.state.currentValue == null ? '' : this.state.currentValue })));
        }
    };
