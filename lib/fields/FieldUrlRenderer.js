...
var FieldUrlRenderer = (function (_super) {
    ...
    FieldUrlRenderer.prototype.renderNewOrEditForm = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(TextField, { onChange: function (evt, newValue) { return _this.onValueChange(newValue, true); }, value: this.state.urlPart == null ? '' : this.state.urlPart, placeholder: "Enter a URL" }),
            React.createElement(TextField, { onChange: function (evt, newValue) { return _this.onValueChange(newValue, false); }, value: this.state.descPart == null ? '' : this.state.descPart, placeholder: "Enter display text" })));
    };
