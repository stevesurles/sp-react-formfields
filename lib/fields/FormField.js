    ...
    function FormField(props) {
        ...
        _this.SpecificFormField = function (fieldProps) {
            ...
            if (fieldProps.Type === 'Text') {
                return React.createElement(FieldTextRenderer, __assign({}, fieldProps, { onChange: function (evt, newValue) { return _this.onChange(evt, newValue); }, key: fieldProps.InternalName, saveChangedFieldData: onFieldDataChangeCallback }));
            }
