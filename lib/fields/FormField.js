...
var FormField = (function (_super) {
    ...
    function FormField(props) {
        ...
        _this.SpecificFormField = function (fieldProps) {
            ...
            if (fieldProps.Type === 'Text') {
                return React.createElement(FieldTextRenderer, __assign({}, fieldProps, { onChange: _this.onChange.bind(_this), key: fieldProps.InternalName, saveChangedFieldData: onFieldDataChangeCallback }));
            }
    ...
    FormField.prototype.onChange = function (evt) {
